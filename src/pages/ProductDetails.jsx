...
const ProductDetails = () => {
 ...
 const handleToggleForm = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto my-12 space-y-8">

      {/* details */}
        <div className="bg-white shadow-xl rounded-xl mx-auto my-12 border border-gray-100 overflow-hidden max-w-5xl">


      <div className="w-full h-40 md:h-60 lg:h-72 bg-gray-50 p-2">
        <img src={image} alt={plantName} className="w-full h-full object-cover rounded-t-xl" />
      </div>
      ...
      <div className="px-6 md:px-10 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 text-gray-800 mb-6">
          <div className="bg-green-100 rounded-lg py-3 text-center hover:bg-green-50 transition">
            <p className="text-sm md:text-base text-gray-700 mb-1">Price</p>
            <p className="font-semibold text-lg text-green-700">${price}</p>
          </div>
          <div className="bg-green-100 rounded-lg py-3 text-center hover:bg-green-50 transition">
            <p className="text-sm md:text-base text-gray-700 mb-1">Rating</p>
            <p className="font-semibold text-lg text-yellow-600">{rating}</p>
          </div>
          <div className="bg-green-100 rounded-lg py-3 text-center hover:bg-green-50 transition">
            <p className="text-sm md:text-base text-gray-700 mb-1">In Stock</p>
        ...
        <div className="flex justify-between items-center gap-4 md:gap-6 text-gray-600 text-sm md:text-base mb-6">
          <p><span className="font-semibold text-gray-800">Category: </span>{category}</p>
          <p><span className="font-semibold text-gray-800">Care Level: </span>{careLevel}</p>
        </div>
      ...
      <div>
        ...
        {showForm && (
          <form
            className="max-w-md mx-auto bg-gray-50 p-6 rounded-xl shadow-md"
            onSubmit={handleSubmit}
          >
            <h3 className="text-xl font-semibold mb-4 text-gray-800 text-center">Your Info</h3>
            <div className="mb-4">
